...
func (x *fileServiceDownloadClient) Recv() (*DownloadReesponse, error) {
	m := new(DownloadReesponse)
...
func (x *fileServiceDownloadServer) Send(m *DownloadReesponse) error {
