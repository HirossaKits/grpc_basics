...
func (x *DownloadReesponse) Reset() {
	*x = DownloadReesponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DownloadReesponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DownloadReesponse) ProtoMessage() {}

func (x *DownloadReesponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_file_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DownloadReesponse.ProtoReflect.Descriptor instead.
func (*DownloadReesponse) Descriptor() ([]byte, []int) {
	return file_proto_file_proto_rawDescGZIP(), []int{3}
}

func (x *DownloadReesponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_proto_file_proto_rawDesc = []byte{
	...
	0x0a, 0x11, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x89, 0x01, 0x0a, 0x0b, 0x46, 0x69, 0x6c, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3c, 0x0a, 0x08, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61,
	...
	0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
...
var file_proto_file_proto_goTypes = []interface{}{
	...
	(*DownloadReesponse)(nil), // 3: file.DownloadReesponse
}
var file_proto_file_proto_depIdxs = []int32{
	...
	3, // 3: file.FileService.Download:output_type -> file.DownloadReesponse
...
func file_proto_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_file_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DownloadReesponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
